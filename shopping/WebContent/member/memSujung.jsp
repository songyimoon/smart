...
<tr>
	<td>우편번호</td>
	<td><input type="text" name="postNumber" id="sample4_postcode" value="${dto.postNumber }"></td>
</tr>
<tr>
	<td>주소</td>
...
<tr>
	<td>생년월일</td>
	<td><input type="date" name="memBirth" value="${dto.memBirth }"></td>
</tr>
<tr>
	<td>성별</td>
	<td>
		<c:if test="${dto.memGender == 'M'}">남성</c:if>
		<c:if test="${dto.memGender == 'F'}">여성</c:if>
	</td>
</tr>
<tr>
	<td>계좌번호</td>
...
<tr>
	...
	<td><input type="radio" name="memEmailCk" value="Y" 
		...
		<c:if test="${dto.memEmailCk == 'N' }">checked</c:if>>아니오
	</td>
</tr>
<tr>
